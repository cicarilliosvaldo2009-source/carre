  ...
  return (
    <div className="app-shell">
      <style>{`
        ...
        /* Calendario — Google Calendar embebido */
        .view-sin-padding-abajo { display: flex; flex-direction: column; padding-left: 0; padding-right: 0; }
        .view-head-calendario { flex-shrink: 0; padding: 0 16px; }
        ...
        .calendario-edicion-barra { flex-shrink: 0; display: flex; align-items: center; gap: 12px; flex-wrap: wrap; margin: 10px 0 4px; padding: 0 16px; }
        ...
        .calendario-celda-hoy { background: color-mix(in srgb, var(--forest) 16%, var(--paper-2)); border-color: var(--forest); }
        ...
        .subtareas-lista li { display: flex; align-items: center; gap: 8px; padding: 5px 6px 5px 14px; border-radius: 6px; }
