  ...
  return (
    <div className={`app-shell ${tema === "oscuro" ? "app-shell-oscuro" : ""}`}>
      <style>{`
        ...
        .color-picker { max-width: 370px; padding: 14px 16px 16px; border: 1px solid var(--line); border-radius: 14px; background: var(--card); box-shadow: 0 5px 16px rgba(35,39,31,0.06); }
