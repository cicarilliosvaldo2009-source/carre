  ...
  return (
    <div className="detalle-overlay" onMouseDown={(e) => e.target === e.currentTarget && onClose()}>
      <div className="detalle-panel">
        ...
        {previewArchivo && (
          <Modal title={previewArchivo.archivoNombre || previewArchivo.nombre} onClose={() => setPreviewArchivo(null)} wide>
            {previewArchivo.archivoTipo === "application/pdf" ? (
              <iframe src={previewArchivo.archivo} title="Vista previa del PDF" className="visor-pdf" />
            ) : previewArchivo.archivoTipo?.startsWith("image/") ? (
              <img src={previewArchivo.archivo} alt={previewArchivo.archivoNombre || previewArchivo.nombre} className="visor-imagen" />
            ) : (
              <p className="muted">No hay vista previa disponible para este tipo de archivo.</p>
            )}
          </Modal>
        )}
  ...
  return (
    <div className="app-shell">
      <style>{`
        ...
        .visor-pdf { width: 100%; height: 72vh; min-height: 420px; border: 1px solid var(--line); border-radius: 8px; }
        .visor-imagen { width: 100%; max-height: 72vh; object-fit: contain; border-radius: 8px; display: block; }
